...
You can rename a column by opening the drop-down menu at the top of the column you wish to rename and choosing `Edit column -> Rename this column`. You will then be prompted to enter the new column name.
