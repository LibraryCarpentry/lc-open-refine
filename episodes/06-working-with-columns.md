...
![New Sort menu appears above grid after first sort command](fig/sort-menu-highlight.png){alt="The top 'Show as' row of the OpenRefine grid changes after first sort command. An additional menu labeled Sort now follows the number of rows displayed."}
