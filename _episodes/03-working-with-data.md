...
OpenRefine comes with a safety belt: note the left column, currently empty. Read the four words at the top of the column:
Facet/Filter and Undo/Redo.  We will focus on the undo/redo button much later in the workshop; you are welcome to use it at anytime, as needed. 
